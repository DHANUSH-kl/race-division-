...
export default function Platforms() {
  ...
  return (
    <section id="platforms" className="py-20 md:py-32 relative z-10 bg-[#faf9f6] border-t border-black/[0.03] overflow-hidden rounded-t-[2.5rem] shadow-[0_-24px_60px_-10px_rgba(0,0,0,0.12)]">
