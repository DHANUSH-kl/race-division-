export default function Platforms() {
  return (
    <section className="py-24 border-y border-white/5 bg-neutral-950/30 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-6 mb-12 reveal-on-scroll">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tighter text-neutral-100">Platforms We Master</h2>
        </div>
        
        <div className="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-8 px-6 space-x-6 reveal-on-scroll delay-100" style={{ scrollbarWidth: "none" }}>
            <div className="snap-center shrink-0 w-[280px] md:w-[350px] aspect-[4/3] img-placeholder rounded-2xl p-6 flex flex-col justify-end relative group overflow-hidden">
