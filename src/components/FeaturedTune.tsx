...
export default function FeaturedTune() {
  ...
  return (
    <section className="py-20 md:py-32 relative bg-white border-y border-black/5 overflow-hidden">
      
      {/* Matched Header Alignment */}
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full mb-12 md:mb-16">
          <div className="reveal-on-scroll">
            <span className="text-[10px] md:text-xs font-semibold tracking-widest uppercase text-red-600 mb-3 block">
              Most Requested by Riders
            </span>
            <h2 className="text-3xl md:text-4xl xl:text-5xl font-semibold tracking-tighter text-neutral-900 mb-5">
              The Most Popular ECU Tune for RE 650
            </h2>
          </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* Left: Image Block */}
          <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-neutral-100 border border-black/5 group">
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-2xl md:text-3xl font-bold tracking-tighter text-neutral-900 mb-5 uppercase">
              Royal Enfield GT 650 / Interceptor 650
            </h3>
            
            <p className="text-sm md:text-base text-neutral-500 max-w-lg leading-relaxed mb-8">
            ...
            <ul className="space-y-3 mb-10 border-l-2 border-red-600/20 pl-4 py-1">
              {[
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mb-8">
              ...
              <a href="#services" className="w-full sm:w-auto px-6 py-3 bg-[#faf9f6] text-neutral-900 font-semibold rounded-full hover:bg-neutral-100 border border-black/5 transition-colors duration-300 flex items-center justify-center gap-2 text-sm md:text-base">
                Learn More
              </a>
            </div>

            {/* Standard Trust Element */}
            <div className="inline-flex items-center gap-2 text-[11px] md:text-xs font-semibold uppercase tracking-widest text-neutral-500">
