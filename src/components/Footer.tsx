    ...
    <footer className="py-12 border-t border-black/5 bg-[#f5f5f7] text-sm mt-auto">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
                <span className="text-neutral-900 font-bold tracking-tighter text-xl uppercase">Racedevision</span>
            </div>
            ...
            <p className="text-neutral-400 text-xs text-center md:text-left">
                &copy; {new Date().getFullYear()} Race Devision. All rights reserved.
            </p>
        </div>
    </footer>
  );
