...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col items-center text-center reveal-on-scroll">
            ...
            <p className="text-base md:text-lg max-w-2xl text-neutral-400 mb-10 font-light leading-relaxed">
                Precision ECU tuning, performance upgrades, and state-of-the-art dyno diagnostics for superbikes. Engineered for the elite riders of Mumbai.
            </p>
